  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald/5 via-white to-sage/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-onyx mb-2">Semua Masukan Saya</h1>
        ...
        {error ? (
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-2xl p-12 border border-gray-100 shadow-lg text-center">
            ...
            <Link 
              ...
              className="bg-emerald hover:bg-sage text-white px-6 py-3 rounded-lg font-medium transition-colors inline-block"
            >
              Kirim Masukan
            </Link>
          </div>
          ...
          <div className="space-y-6">
            {feedbacks.map((feedback) => (
              <div key={feedback.id} className="bg-white/95 backdrop-blur-md rounded-2xl p-6 border border-gray-100 shadow-lg">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-onyx mb-2">{feedback.title}</h3>
                    <p className="text-gray-600 mb-4">{feedback.content}</p>
                  </div>
                  <span className={`ml-4 px-3 py-1 rounded-full text-sm font-medium ${feedback.statusColor}`}>
